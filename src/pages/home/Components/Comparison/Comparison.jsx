  ...
  return (
    <div className="comparison container">
      ...
      <div className="comparison__content">
          <img className='comprassion__img_item comprassion__img_left' src={comparison_1} alt="#" />
        ...
        <div className="comparison__content_text comparison__content_online">
          ...
          <img className='comprassion__img_item comprassion__img_right' src={comparison_2} alt="#" />
...
//       <h3>Глянем сравнение:</h3>
//       <div className="comparison__content">
//         <div className="comparison__img comprassion__img_left">
//           <img className='comprassion__img_item' src={comparison_1} alt="#" />
//         </div>
//         <div className="comparison__content_text comparison__content_school">
//           <h3>Обычная школа</h3>
//           <ul className="comparison__content_list">
...
//           </ul>
//         </div>
//         <div className="comparison__img  comprassion__img_right">
//           <img className='comprassion__img_item' src={comparison_2} alt="#" />
//         </div>
//       </div>
//     </div>
//   );
